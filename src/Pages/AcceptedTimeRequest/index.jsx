...
import ApprovedTimeCampaigns from '../../Components/ApprovedTimeCampaigns';

const AcceptedTimeRequest = () => {
  ...
  useEffect(() => {
    ...
    axios.get(
      // body: JSON.stringify({
      `${process.env.REACT_APP_API_URL}/api/admin/acceptedtimeextensionrequests`,
      {
        headers: {
  ...
  return (
    <div>
      {loading ?
        ...
        :
        <ApprovedTimeCampaigns campaignsData={campaignsData} />
      }
    </div>
  )
}

export default AcceptedTimeRequest
